 ...
 * {@link DevEmFragment.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link DevEmFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class DevEmFragment extends Fragment {
    ...
    public static DevEmFragment newInstance(String param1, String param2) {
        DevEmFragment fragment = new DevEmFragment();
...
String TAG = "DEVEM";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_dev_em, container, false);

        recyclerView = (RecyclerView) view.findViewById(R.id.recyclerview_em);
        btnRefresh = (Button) view.findViewById(R.id.devEmFragment_btn_refresh) ;
        btnHistory = (Button) view.findViewById(R.id.devEmFragment_btn_his) ;

        txtInfo = view.findViewById(R.id.devEmFragment_txt_info);
